...
const Records = (props: Props): JSX.Element => {
  ...
  const page =
    parseInt(JSON.parse(JSON.stringify(qs.parse(props.location.search))).page, 10) || 1;
  const size =
    parseInt(JSON.parse(JSON.stringify(qs.parse(props.location.search))).size, 10) || 10;
